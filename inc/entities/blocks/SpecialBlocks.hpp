...
class CrackedStoneBricksBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(CrackedStoneBricksBlock)
...
class StoneBrickBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(StoneBrickBlock)
...
class MossyStoneBricksBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(MossyStoneBricksBlock)
...
class ChiseledStoneBricksBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(ChiseledStoneBricksBlock)
...
class YellowWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(YellowWool)
...
class BlueWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(BlueWool)
...
class GreenWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(GreenWool)
...
class OrangeWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(OrangeWool)
...
class PurpleWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(PurpleWool)
...
class WhiteWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(WhiteWool)
...
class BlackWool : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(BlackWool)
...
class OakLogBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(OakLogBlock)
...
class BirchLogBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(BirchLogBlock)
...
class BirchLeavesBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(BirchLeavesBlock)
...
class OakLeavesBlock : public Block {
 public:
  ...
  IMPLEMENT_BLOCK_CLONE(OakLeavesBlock)
