...
void ItemRepository::loadItems() {
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(coal_ore_block.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(diamond_ore_block.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(iron_ore_block.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(gold_ore_block.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(redstone_ore_block.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(emerald_ore_block.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(oak_planks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(spruce_planks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(birch_planks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(acacia_planks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(stone_brick.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(cracked_stone_bricks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(mossy_stone_bricks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(chiseled_stone_bricks.sprite.getId());
  ...
  this->t_renderer->core.texture.repository
      ...
      ->addLink(stripped_oak_wood.sprite.getId());
}
...
void ItemRepository::linkTextureByItemType(ITEM_TYPES itemType,
  ...
  this->t_renderer->core.texture.repository
      .getBySpriteOrMesh(getSpriteByItemType(itemType).getId())
      ->addLink(t_spriteId);
}
...
void ItemRepository::removeTextureLinkByBlockType(ITEM_TYPES itemType,
  ...
  Texture* tex = this->t_renderer->core.texture.repository.getBySpriteOrMesh(
      getSpriteByItemType(itemType).getId());
