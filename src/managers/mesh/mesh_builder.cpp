...
void MeshBuilder_RegisterBuilders() {
  builders = {
      ...
      {Blocks::YELLOW_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::BLUE_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::GREEN_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::ORANGE_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::PURPLE_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::RED_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::WHITE_CONCRETE, CuboidMeshBuilder_GenerateMesh},
      {Blocks::BLACK_CONCRETE, CuboidMeshBuilder_GenerateMesh},
  ...
  light_builders = {
      ...
      {Blocks::YELLOW_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::BLUE_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::GREEN_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::ORANGE_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::PURPLE_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::RED_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::WHITE_CONCRETE, CuboidMeshBuilder_loadLightData},
      {Blocks::BLACK_CONCRETE, CuboidMeshBuilder_loadLightData},
